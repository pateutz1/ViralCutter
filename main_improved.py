...
def main():
    ...
    parser.add_argument("--face-detect-interval", type=str, default="0.17,0.35", help="Face detection interval in seconds. Single value or 'interval_1face,interval_2face'")
