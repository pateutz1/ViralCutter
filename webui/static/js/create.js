...
<form id="create-form">
  ...
  <div class="vc-grid vc-grid-32">
    <section class="vc-card">
      ...
      <div class="vc-row">
        <div class="vc-field"><label for="segments">Segments</label><input class="vc-input" id="segments" name="segments" type="number" data-num="1" /></div>
        <label class="vc-check" style="padding-bottom:18px"><input type="checkbox" id="viral" name="viral" /> <strong>Viral Mode</strong></label>
      </div>
      <div class="vc-field" id="field-themes">
        <label for="themes">Themes</label>
        <input class="vc-input" id="themes" name="themes" placeholder="funny, sad..." />
      </div>
      <div class="vc-row">
        <div class="vc-field"><label for="min_duration">Min Duration (s)</label><input class="vc-input" id="min_duration" name="min_duration" type="number" data-num="1" /></div>
        <div class="vc-field"><label for="max_duration">Max Duration (s)</label><input class="vc-input" id="max_duration" name="max_duration" type="number" data-num="1" /></div>
      </div>
    ...
    <section class="vc-card">
      ...
      <div class="vc-row">
        ...
        <label class="vc-check" style="padding-bottom:18px"><input type="checkbox" id="enable_captions" name="enable_captions" /> <strong>Enable Captions</strong></label>
      </div>
      <div class="vc-field">
  ...
  <section class="vc-card">
    ...
    <div class="vc-row">
      <div class="vc-field"><label for="face_detect_interval">Face Det. Interval</label><input class="vc-input" id="face_detect_interval" name="face_detect_interval" /></div>
  ...
  <details class="vc-card">
    ...
    <div class="vc-row">
      ...
      <label class="vc-check" style="padding-bottom:18px"><input type="checkbox" id="use_custom_subs" name="use_custom_subs" /> <strong>Enable Subtitle Customization</strong></label>
    </div>
...
function applyFields(data) {
  Object.entries(data || {}).forEach(([key, value]) => {
    const el = document.querySelector(`#create-form [name="${key}"]`);
    setField(el, value);
    if (el && el.type === "radio") {
...
function formPayload() {
  ...
  if (!form) return { ...VC.state, api_key: VC.apiKey };
  const data = collectNamed(form);
